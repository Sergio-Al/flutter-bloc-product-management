...
class GetLotesByFacturaUsecase {
  final LoteRepository repository;

  GetLotesByFacturaUsecase(this.repository);

  Future<Either<Failure, List<Lote>>> call(String facturaId) {
    return repository.getLotesByFactura(facturaId);
  }
}
