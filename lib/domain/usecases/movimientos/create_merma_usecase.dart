  ...
  Future<void> call({
    ...
    currentUserResult.fold(
      ...
      (user) async {
        ...
        final result = await movimientoRepository.createMerma(
        ...
        result.fold(
          (failure) {
            throw Exception('Failed to create merma: ${failure.message}');
          },
          (movimiento) {
            // Merma created successfully
          },
        );
      },
    );
