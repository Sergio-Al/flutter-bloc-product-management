...
class SearchProveedoresUsecase {
  ...
  SearchProveedoresUsecase({required this.proveedorRepository});

  Future<Either<Failure, List<Proveedor>>> call(String query) {
    return proveedorRepository.searchProveedores(query);
  }
}
