...
class _LoteDetailPageState extends State<LoteDetailPage> {
  ...
  /// Edit: Gerente and Almacenero
  /// Delete: No one can delete lotes
  List<Widget> _buildAppBarActions(BuildContext context) {
    ...
    if (PermissionHelper.canEditLote(userRole)) {
      actions.add(
        IconButton(
    ...
    // Delete button - No one can delete lotes per PERMISOS.md
    // Intentionally removed - deletion is prohibited for all roles
    //
    // ═══════════════════════════════════════════════════════════════════════════
    // TO RESTORE DELETE FUNCTIONALITY:
    // 1. Add canDeleteLote to PermissionHelper (already exists, returns false)
    // 2. Modify canDeleteLote to return true for desired roles
    // 3. Uncomment the block below
    // 4. Uncomment _confirmDelete method at the bottom of this file
    // ═══════════════════════════════════════════════════════════════════════════
    // if (PermissionHelper.canDeleteLote(userRole)) {
    //   actions.add(
    //     IconButton(
  ...
  //             context.read<LoteBloc>().add(DeleteLote(widget.loteId));
  //           },
